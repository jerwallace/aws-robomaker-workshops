---
title: "Activity #1: Run a Robot Simulation in RoboMaker"
chapter: true
weight: 4
description: In this activity you will setup a development environment and build, bundle, and simulate an application with a single robot.
---
